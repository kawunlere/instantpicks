...
export function renderAnalyze() {
  ...
  const body = '<div class="head"><div class="logo">⚡ ANALYZE ⚡</div><div class="tag">SMART MATCH ANALYSIS</div></div>' +
    ...
    '<div id="matches">' +
    '<div class="card" id="match_1"><h3 class="ct">MATCH 1 (Required)</h3>' +
    '<div class="row"><div><label>TEAM A</label><input id="m1_team_a" placeholder="e.g. Chelsea"></div>' +
    '<div><label>TEAM B</label><input id="m1_team_b" placeholder="e.g. Tottenham"></div></div>' +
    '<div class="row"><div><label>TEAM A POS</label><input id="m1_pos_a" type="number" placeholder="3"></div>' +
    '<div><label>TEAM B POS</label><input id="m1_pos_b" type="number" placeholder="7"></div></div>' +
    '<label>TEAM A FORM (tap buttons)</label>' +
    '<div style="display:flex;gap:5px;margin:8px 0">' +
    '<button type="button" onclick="addForm(1,\'a\',\'W\')" style="flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700">W</button>' +
    '<button type="button" onclick="addForm(1,\'a\',\'D\')" style="flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700">D</button>' +
    '<button type="button" onclick="addForm(1,\'a\',\'L\')" style="flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700">L</button>' +
    '</div>' +
    '<input id="m1_form_a" placeholder="W,L,D,W,W">' +
    '<label style="margin-top:10px;display:block">TEAM B FORM</label>' +
    '<div style="display:flex;gap:5px;margin:8px 0">' +
    '<button type="button" onclick="addForm(1,\'b\',\'W\')" style="flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700">W</button>' +
    '<button type="button" onclick="addForm(1,\'b\',\'D\')" style="flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700">D</button>' +
    '<button type="button" onclick="addForm(1,\'b\',\'L\')" style="flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700">L</button>' +
    '</div>' +
    '<input id="m1_form_b" placeholder="L,W,L,D,W">' +
    '</div></div>' +
    ...
    'function addMatch(){matchCount++;var h="<div class=\"card\" id=\"match_"+matchCount+"\"><button type=\"button\" onclick=\"removeMatch("+matchCount+")\" style=\"background:#1a0000;color:#ff3333;border:1px solid #ff3333;border-radius:5px;padding:4px 8px;cursor:pointer;font-size:10px;float:right\">REMOVE</button><h3 class=\"ct\">MATCH "+matchCount+" (Optional)</h3>"' +
    '"<div class=\"row\"><div><label>TEAM A</label><input id=\"m"+matchCount+"_team_a\" placeholder=\"e.g. Chelsea\"></div>"' +
    '"<div><label>TEAM B</label><input id=\"m"+matchCount+"_team_b\" placeholder=\"e.g. Tottenham\"></div></div>"' +
    '"<div class=\"row\"><div><label>TEAM A POS</label><input id=\"m"+matchCount+"_pos_a\" type=\"number\" placeholder=\"3\"></div>"' +
    '"<div><label>TEAM B POS</label><input id=\"m"+matchCount+"_pos_b\" type=\"number\" placeholder=\"7\"></div></div>"' +
    '"<label>TEAM A FORM</label><div style=\"display:flex;gap:5px;margin:8px 0\">"+"<button type=\"button\" onclick=\"addForm("+matchCount+",\\\'a\\\',\\\'W\\\') \" style=\"flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700\">W</button>"+"<button type=\"button\" onclick=\"addForm("+matchCount+",\\\'a\\\',\\\'D\\\') \" style=\"flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700\">D</button>"+"<button type=\"button\" onclick=\"addForm("+matchCount+",\\\'a\\\',\\\'L\\\') \" style=\"flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700\">L</button></div>"' +
    '"<input id=\"m"+matchCount+"_form_a\" placeholder=\"W,L,D,W,W\">"+"<label style=\"margin-top:10px;display:block\">TEAM B FORM</label><div style=\"display:flex;gap:5px;margin:8px 0\">"+"<button type=\"button\" onclick=\"addForm("+matchCount+",\\\'b\\\',\\\'W\\\') \" style=\"flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700\">W</button>"+"<button type=\"button\" onclick=\"addForm("+matchCount+",\\\'b\\\',\\\'D\\\') \" style=\"flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700\">D</button>"+"<button type=\"button\" onclick=\"addForm("+matchCount+",\\\'b\\\',\\\'L\\\') \" style=\"flex:1;padding:10px;background:rgba(0,0,0,.5);color:#fff;border:1px solid #333;border-radius:6px;cursor:pointer;font-family:inherit;font-weight:700\">L</button></div>"' +
    '"<input id=\"m"+matchCount+"_form_b\" placeholder=\"L,W,L,D,W\"></div>";' +
